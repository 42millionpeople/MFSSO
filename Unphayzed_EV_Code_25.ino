...
double wheelDiameterCM = 4.98; //Wheel diameter in cm

//Adjust variables to change the distance your vehicle travels.
double targetDistanceM = 8.28; //Target Distance in m
double slowDownDistance = 4.10; //Distance where vehicle begins to slow down in m
